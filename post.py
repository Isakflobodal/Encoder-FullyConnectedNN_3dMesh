...
# load trained model
config = torch.load("model_check_point_80_best.pth")
model = NeuralNet(layer_sizes = [128,128,128, dim*dim*dim*3], cnn_layer_sizes=[32,32,32], dropout=0.0 ,device="cpu")
